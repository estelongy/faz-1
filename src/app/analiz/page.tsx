      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-24 pb-16">
        ...
        {step === 'upload' && (
          <div>
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400">Selfie yükle, Estelongy AI ile ön analizin saniyeler içinde hazır.</p>
            </div>
        ...
        {step === 'processing' && (
          <div className="text-center py-16">
            ...
            <p className="text-slate-400 mb-8">Estelongy AI analiz ediyor, Estelongy Algoritması hesaplanıyor...</p>
          ...
          <div>
            <div className="text-center mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-xs font-semibold mb-4">
                ...
                {usedFallback ? 'Ön Analiz · Tahmini Skor (AI servisi geçici kapalı)' : 'Estelongy AI · Estelongy Algoritması'}
              </div>
