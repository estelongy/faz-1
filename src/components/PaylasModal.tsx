          ...
          >
            ...
            <div className="grid grid-cols-4 gap-3 mb-5">
              <a href={waUrl} target="_blank" rel="noopener noreferrer"
                className="flex flex-col items-center gap-1 p-3 rounded-xl bg-[#25D366]/15 hover:bg-[#25D366]/25 transition-colors">
              ...
              <a href={twitterUrl} target="_blank" rel="noopener noreferrer"
                className="flex flex-col items-center gap-1 p-3 rounded-xl bg-black/40 hover:bg-black/60 transition-colors">
              ...
              <a href={facebookUrl} target="_blank" rel="noopener noreferrer"
                className="flex flex-col items-center gap-1 p-3 rounded-xl bg-[#1877F2]/15 hover:bg-[#1877F2]/25 transition-colors">
              ...
              <a href={telegramUrl} target="_blank" rel="noopener noreferrer"
                className="flex flex-col items-center gap-1 p-3 rounded-xl bg-[#0088cc]/15 hover:bg-[#0088cc]/25 transition-colors">
